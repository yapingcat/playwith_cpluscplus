...
struct Sdp
{
    ...
    {
        return !((sessionDescription.version == -1) && (mediaDescriptions.size() == 0));
    }
};


void parserAttribute(const std::string& attr);
